...
|---|---|
| `--fontFamily-<voice>` | `heading`, `display`, `body`, `code`, `label`, `button`, `nav`, `preamble` |
| `--fontWeight-<voice>` | `heading`, `display`, `body`, `body-bold`, `code`, `label`, `button`, `nav`, `preamble` |
| `--lineHeight-<voice>` | `heading`, `display`, `body`, `label`, `button`, `nav`, `preamble` |
| `--letterSpacing-<voice>` | `heading`, `display`, `body`, `label`, `button`, `nav`, `preamble` |
| `--fontFeatureSettings-<voice>` | `heading`, `display`, `body`, `label`, `button`, `nav`, `preamble` |
| `--baseline-offset-<voice>` | `heading`, `display`, `body`, `label`, `button`, `nav`, `preamble` |
| `--fontEmBox-<voice>` | `heading`, `display`, `body`, `label`, `button`, `nav`, `preamble` |
| `--fontCapGap-<voice>` | `heading`, `display`, `body`, `label`, `button`, `nav`, `preamble` |
...
## 5. RAW constants (262) — never in a component
...
- `--FONTSIZE-<STOP>-<TIER>` (100), tiers `FLOOR`, `MOBILE`, `DESKTOP`, `WIDE`
- `--SPACE-SCALE`
