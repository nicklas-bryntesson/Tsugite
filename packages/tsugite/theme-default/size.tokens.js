...
/** rem per tier. Order is the scale order — emitted top to bottom. The keys are
    token names, not identifiers, so every one is quoted (the typography tables
    do the same); 2xl would need the quotes anyway. */
