...
export const typeVoices = {
  ...
  button: {
    // The pressable voice. Label's values today, on purpose: same value, separate
    // knob, so a brand with condensed buttons and airy labels turns one without the
    // other. Button.css reads this bundle; Caption speaks it as a variant.
    family: "--INTER",
    weights: { default: "--INTER-400" },
    lineHeight: "1.3",
    letterSpacing: "normal",
