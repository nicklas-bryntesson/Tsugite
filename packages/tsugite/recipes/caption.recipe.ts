...
// marks the interface up — labels, legends, figcaptions, table headers, hints) and button
// (the pressable voice, which Button.css reads as tokens and this door speaks standalone).
// One door, two sibling voices, like Heading with heading and display. The farm is the
...
export const caption = {
  ...
  refuses: [
    ...
    "being the button — Button reads the button voice; this door only speaks it",
  ...
  axes: {
    variant: { values: ["label", "button"], default: "label" },
    size: { valuesBy: { axis: "variant", values: { label: ["sm", "md", "lg"], button: ["sm", "md", "lg"] } }, default: "md" },
