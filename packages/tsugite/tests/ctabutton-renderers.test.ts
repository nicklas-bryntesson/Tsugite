...
// tests/fixtures/ctabutton.json lists inputs and the exact resolution each must produce.
...
const fixture: Fixture = JSON.parse(readFileSync(new URL("./fixtures/ctabutton.json", import.meta.url), "utf8"));
