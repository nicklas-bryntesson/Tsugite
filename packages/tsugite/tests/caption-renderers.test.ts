// The recipe is a table read by lib/recipe.ts (ADR-0018). tests/fixtures/caption.json lists
...
const fixture: Fixture = JSON.parse(readFileSync(new URL("./fixtures/caption.json", import.meta.url), "utf8"));
