...
test('all kitchensink states pass axe', async ({ page }) => {
  ...
  // PORT ADAPTATION: the reference selector keyed on its own kitchensink
  // section class (.kitchensink-section:has(…)); our demo section carries
  // the #AffixField id — same scope.
